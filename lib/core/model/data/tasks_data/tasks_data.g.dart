...
extension TaskDataQueryFilter
  ...
  QueryBuilder<TaskData, TaskData, QAfterFilterCondition> endDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'endDate',
  ...
  QueryBuilder<TaskData, TaskData, QAfterFilterCondition> endDateGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskData, TaskData, QAfterFilterCondition> endDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskData, TaskData, QAfterFilterCondition> endDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskDataQuerySortBy on QueryBuilder<TaskData, TaskData, QSortBy> {
  ...
  QueryBuilder<TaskData, TaskData, QAfterSortBy> sortByEndDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'endDate', Sort.asc);
    });
  }

  QueryBuilder<TaskData, TaskData, QAfterSortBy> sortByEndDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskDataQuerySortThenBy
  ...
  QueryBuilder<TaskData, TaskData, QAfterSortBy> thenByEndDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'endDate', Sort.asc);
    });
  }

  QueryBuilder<TaskData, TaskData, QAfterSortBy> thenByEndDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'endDate', Sort.desc);
    });
  }
...
extension TaskDataQueryWhereDistinct
  ...
  QueryBuilder<TaskData, TaskData, QDistinct> distinctByEndDate() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskDataQueryProperty
  ...
  QueryBuilder<TaskData, DateTime, QQueryOperations> endDateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskData, int, QQueryOperations> priorityProperty() {
    return QueryBuilder.apply(this, (query) {
